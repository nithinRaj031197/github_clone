      ...
      <motion.div className="flex md:pl-7 space-x-3 md:space-x-10">
        ...
        >
          ...
          >
            ...
            With GitHub, developers can secure their code in minutes and organizations can automatically comply with
            regulations.
          </h3>
        </motion.div>
      </motion.div>
        ...
        <HoverCard backgroundColor="#939aff" direction="" left="0">
          <div className="overflow-auto md:flex flex-col md:space-y-20 flex-1 py-20 md:p-10 p-5 my-6    justify-between md:min-w-[400px]">
            <p className=" text-xl md:text-2xl mb-6 font-medium text-[#7d8590]">
              <span className="text-white font-medium">GitHub Sponsors</span> lets you support your favorite open source
      ...
      <div className="flex flex-col md:flex-row gap-10 ">
        <HoverCard backgroundColor="#939aff" direction="flex-col" left="0">
          <div className="md:flex flex-col flex-1 p-8 sm:p-10 lg:py-16 lg:pl-16 lg:pr-32">
            <p className=" text-xl md:text-2xl mb-6 font-medium text-[#7d8590]">
              <span className="text-white font-semibold">Dependabot</span> makes it easy to find and fix vulnerable
        ...
        <HoverCard backgroundColor="#939aff" direction="flex-col" left="-400px">
          <div className="md:flex flex-col  flex-1 p-8 sm:p-10 lg:py-16 lg:pl-16 lg:pr-32 ">
            <p className=" text-xl md:text-2xl mb-6 font-medium text-[#7d8590]">
              <span className="text-white font-semibold">Code scanning</span>is GitHub’s static code analysis tool that
