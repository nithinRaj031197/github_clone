    ...
    <HoverCard backgroundColor="#7ee787" direction="" left="0">
      <div className="md:flex flex-col md:space-y-20 flex-1 p-8 sm:p-10 lg:py-16 lg:pl-16 lg:pr-32 justify-between ">
        <p className=" text-xl md:text-2xl mb-6 font-medium text-[#7d8590]">
          <span className="text-white font-medium">GitHub Copilot</span> is your AI pair programmer that empowers you to
              ...
              <div className="flex items-center bg-[#161b22] text-[#7d8590] tab-nav">
                <button
                  ...
                  className={`flex items-center  py-2 px-4 ${
                    showPy ? "border-[0.5px] rounded-t-md border-b-[0] text-white border-[#30363d] bg-[#0d1117]" : ""
                  }  `}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <button
                  ...
                  type="button"
                  className={`flex items-center py-2 px-4 ${
                    showJs ? "border-[0.5px] rounded-t-md border-b-[0] text-white border-[#30363d] bg-[#0d1117]" : ""
                  }`}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <button
                  ...
                  type="button"
                  className={`flex items-center py-2 px-4 ${
                    showGo ? "border-[0.5px] rounded-t-md border-b-[0] text-white border-[#30363d] bg-[#0d1117]" : ""
                  } `}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
